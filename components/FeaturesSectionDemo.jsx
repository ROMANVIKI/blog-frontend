...
const Feature = ({ title, description, icon, index }) => {
  return (
    <div
      className={cn(
        "flex flex-col w-full  lg:border-r  py-10 relative bg-black group/feature dark:bg-black",
        (index === 0 || index === 4) &&
          "lg:border-l dark:border-neutral-800 border-neutral-800",
        index < 4 && "lg:border-b dark:border-neutral-800 border-neutral-800",
      )}
    >
      {index < 4 && (
